...
<body>
        ...
        <nav class="nav__container">
            <div>
                <a href="#" class="nav__link nav__logo">
                    ...
                    <span class="nav__logo-name">CSUA_AMS</span>
                </a>
    ...
    <center>
        <form method="" action="">
            <h2 class="h2">Scan Employee ID:</h2>
        ...
        <h1>RFID BASED ATTENDANCE MONITORING SYSTEM</h1>
        <p>APARRI CAMPUS</p>
        ...
        if ($countregister == 0) {
                            ?>
                                <script type="text/javascript">
                                    swal({
                                      title: "Ooops!",
                                      text: "<?php echo 'Your ID is not yet registered!'; ?>",
                                      type: "warning",
                                      timer: 1500,
